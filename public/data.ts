const planet = [
  ...
  },
  {
    ...
    "temperature": "471 °C",
    "images": {
      "overview": "./assets/2-1.png",
      "structure": "./assets/2-2.png",
      "geology": "./assets/2-3.png"
    }
  },
  {
    "name": "Earth",
    ...
    "geology": {
      "content": "The total surface area of Earth is about 510 million km². The continental crust consists of lower density material such as the igneous rocks granite and andesite. Less common is basalt, a denser volcanic rock that is the primary constituent of the ocean floors.",
    ...
    "temperature": "16 °C",
    "images": {
      "overview": "./assets/3-1.png",
      "structure": "./assets/3-2.png",
      "geology": "./assets/3-3.png"
    }
  },
  {
    "name": "Mars",
    ...
    "temperature": "-28 °C",
    "images": {
      "overview": "./assets/4-1.png",
      "structure": "./assets/4-2.png",
      "geology": "./assets/4-3.png"
    }
  },
  {
    "name": "Jupiter",
    ...
    "temperature": "-108 °C",
    "images": {
      "overview": "./assets/5-1.png",
      "structure": "./assets/5-2.png",
      "geology": "./assets/5-3.png"
    }
  },
  {
    "name": "Saturn",
    ...
    "structure": {
      "content": "Despite consisting mostly of hydrogen and helium, most of Saturn's mass is not in the gas phase, because hydrogen becomes a non-ideal liquid when the density is above 0.01 g/cm³, which is reached at a radius containing 99.9% of Saturn's mass.",
    ...
    "temperature": "-138 °C",
    "images": {
      "overview": "./assets/6-1.png",
      "structure": "./assets/6-2.png",
      "geology": "./assets/6-3.png"
    }
  },
  {
    "name": "Uranus",
    ...
    "temperature": "-195 °C",
    "images": {
      "overview": "./assets/7-1.png",
      "structure": "./assets/7-2.png",
      "geology": "./assets/7-3.png"
    }
  },
  {
    "name": "Neptune",
    ...
    "temperature": "-201 °C",
    "images": {
      "overview": "./assets/8-1.png",
      "structure": "./assets/8-2.png",
      "geology": "./assets/8-3.png"
    }
  }
]
